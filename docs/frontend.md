...
- Add shadcn components through the registry/CLI flow (https://ui.shadcn.com/docs/mcp) using the project registries in `components.json`; avoid copying snippets by hand and keep Radix structure intact.
...
- Follow `docs/accessibility.md`  single `<main>`, skip link, correct heading order, visible focus, native elements for interactivity.
...
### SEO & Content
- Apply metadata via Next Metadata API on pages; include title/description, OG/Twitter, canonical. See `docs/seo.md`.
